...
\begin{document}
    ...
    \begin{header}
        ...
        \raggedleft
        \centering
        \qrcode[height=1.5cm]{https://www.linkedin.com/in/taminul-islam/}
...
PhD Student in Computer Science with 3.5+ years of expertise in AI/ML, computer vision, and deep learning. Proficient in Python, TensorFlow, and data analysis with strong foundation in statistical modeling and machine learning algorithms. Led cross-functional teams to develop scalable AI solutions for real-world applications, with 28 publications demonstrating ability to deliver high-impact research and translate academic insights into practical solutions.
...
\begin{onecolentry}
    \begin{highlights}
        ...
        % - (Under Review - \textbf{NeurIPS 2025})
